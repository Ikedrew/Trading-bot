"""
Market Context Models — Structured interpretation of market state (Production V1).
...
Combined into MarketContextInterpretation — the complete interpretive layer consumed by the
V10 trading pipeline. (Class name retained as the pipeline's input type.)
...
_CONTEXT_SCHEMA_VERSION = "market_interpretation_v1"
...
# ═══════════════════════════════════════════════════════════════════════════════
# COMPOSITE: MARKET CONTEXT INTERPRETATION
# ═══════════════════════════════════════════════════════════════════════════════


@dataclass(frozen=True)
class MarketContextInterpretation:
    """
    Complete market-context interpretation — structured reading of market state.

    Immutable. Created once per cycle from MarketUnderstanding.
    Consumed by the V10 pipeline (opportunity / horizon / entry / risk / execution).
    """
    # Identity
    symbol: str = ""
