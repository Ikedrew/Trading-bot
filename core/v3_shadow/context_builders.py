"""
V3 Market Context Builders — Transform MarketUnderstanding into structured context.
...
Three independent builders + orchestrator:
    ...
    build_v3_market_context() → V3MarketContext (orchestrates all)
...
def build_v3_market_context(mu: MarketUnderstanding) -> V3MarketContext:
    """
    Build complete V3MarketContext from MarketUnderstanding.
